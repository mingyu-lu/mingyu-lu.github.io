...
Hi! I am a 4th-year computer science & engineering (CSE) Ph.D. student at the University of Washington, advised by [Su-In Lee](https://aims.cs.washington.edu/su-in-lee) in the [Artificial Intelligence for Biological and Medical Sciences (AIMS)](https://aims.cs.washington.edu/) group. My research focuses on explainable and interpretable machine learning, particularly on methods for feature, data, and group attribution. I am interested in decomposing a trained model's behaviors (e.g., accuracy, image quality) into the contributions of different components, such as individual features, samples, or data sources. I am also passionate about applying these techniques to biomedical decision-making and scientific discovery, leveraging machine learning to accelerate real-world impact in healthcare and drug discovery.
