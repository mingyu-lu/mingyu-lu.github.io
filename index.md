...
Previously, I worked with [Li-wei Lehman](https://web.mit.edu/lilehman/www/), [Zach Shahn](https://sph.cuny.edu/about/people/faculty/zach-shahn/), and [Finale Doshi-Velez](https://finale.seas.harvard.edu/). Outside of school, I have spent summers interning at research labs in academia and industry: [LCP](https://lcp.mit.edu/) at MIT, and [Bosch Research](https://www.bosch-ai.com/). I completed my undergraduate studies in Medicine at Kaohsiung Medical University (KMU) and earned a master's degree in Biomedical Informatics from Harvard Medical School's Department of Biomedical Informatics (DBMI).
